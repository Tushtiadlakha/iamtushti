...
const Hero = () => {
  return (
    <>
<section id="home">
	<div className="bg-black text-white py-0 sm:py-20">
		<div className="container mx-auto flex flex-col sm:flex-row items-center md:my-18 justify-around">
			<div className="flex flex-col w-full lg:w-1/3 justify-center items-start p-8 ">
				<h1 className=" text-3xl md:text-5xl p-2 text-yellow-300 tracking-loose font-serif ">Tushti Adlakha</h1>
				<h3 className=" text-2xl ml-4 md:text-3xl leading-relaxed md:leading-snug mb-2 ">A Software Developer</h3>
